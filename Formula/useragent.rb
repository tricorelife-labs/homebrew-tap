class Useragent < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
    url "https://github.com/tricorelife-labs/UserAgent/releases/download/v0.3.19/UserAgent-aarch64-apple-darwin.tar.xz"
    sha256 "8ba2a57288e24c7595b729097671e656df0b6a3e91bc303ccf5c63edd9066874"
  end
  if OS.linux? && Hardware::CPU.intel?
    url "https://github.com/tricorelife-labs/UserAgent/releases/download/v0.3.19/UserAgent-x86_64-unknown-linux-gnu.tar.xz"
    sha256 "e87e8e08b79bfde415208b1907a11486a69ae1a8e4767f7dab4d2ac0e5fc44ea"
  end
  license "MIT"
